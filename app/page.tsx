  ...
  return (
    <div className="w-[80%] border border-white rounded p-4">
      ...
      <p className="m-2  p-2 bg-orange-500/60 text-black border-black rounded">
        ...
        provident vitae ea magnam blanditiis ab aliquid doloremque commodi minus
        quia pariatur quod. Dignissimos quibusdam laboriosam deleniti, deserunt
        reprehenderit debitis nobis qui quod possimus, sapiente ab blanditiis
        hic. Mollitia ipsum atque in earum ab? At rem nulla voluptatum
        consequatur a nesciunt reprehenderit suscipit distinctio temporibus id
        eius sit vero, in repellendus illum, enim quae eos dignissimos unde
        porro assumenda perspiciatis ad ullam. Inventore deserunt placeat
        officiis, voluptate, vero omnis mollitia neque et quos nesciunt facere
        minima!{" "}
      </p>
    </div>
  );
