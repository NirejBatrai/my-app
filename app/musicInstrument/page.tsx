    ...
    try {
      ...
      if (editingId) {
        response = await fetch(
          `http://localhost:3000/musicstore/${editingId}`,
          {
            method: "PATCH",
            headers: {
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        <h2 className="text-xl font-semibold mb-4 text-black">
          {editingId ? "Edit Music Item" : "Add New Music Item"}
        </h2>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md overflow-x-auto">
        ...
        {isLoading && !musicItems.length ? (
          ...
          <p className="text-center text-black">No music items found</p>
        ) : (
          <table className="min-w-full bg-white">
            <thead>
              <tr>
                <th className="py-2 px-4 border-b border-gray-200 bg-gray-50 text-left text-xs font-medium text-black uppercase tracking-wider">
                  ID
                </th>
                <th className="py-2 px-4 border-b border-gray-200 bg-gray-50 text-left text-xs font-medium text-black uppercase tracking-wider">
                  Music Name
